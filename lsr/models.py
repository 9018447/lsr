...
from lsr.openrouter import OpenRouterModelManager
from lsr.sendchat import ensure_alternating_roles, sanity_check_messages
from lsr.utils import check_pip_install_extra
...
class ModelInfoManager:
    ...
    def __init__(self):
        self.cache_dir = Path.home() / ".lsr" / "caches"
...
class Model(ModelSettings):
    ...
    def configure_model_settings(self, model):
        ...
        if (
            ...
            and self.extra_model_settings.name == "lsr/extra_params"
        ):
        ...
        if "GITHUB_COPILOT_TOKEN" in os.environ:
            if "extra_headers" not in kwargs:
                kwargs["extra_headers"] = {
                    "Editor-Version": f"lsr/{__version__}",
